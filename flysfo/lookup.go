...
func NewLookupFuncWithReader(r io.ReadCloser) FlysfoLookupFunc {
...
func NewLookupWithLookupFunc(lookup_func FlysfoLookupFunc) (airlines.Lookup, error) {
